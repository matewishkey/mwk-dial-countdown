 ...
 *
 * Drawn from the same {@link centre} and the same {@link pulse} as the ring layout, so the two
 * cannot disagree about what a state looks like, and winding the dial flashes on both.
 */
